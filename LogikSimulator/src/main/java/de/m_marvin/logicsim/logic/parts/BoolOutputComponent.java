...
public class BoolOutputComponent extends Component implements ISubCircuitIO {
	...
	public static boolean coursorMove(Circuit circuit, Vec2i coursorPosition) {
		return Component.coursorMove(circuit, coursorPosition, () -> new BoolOutputComponent(circuit));
	}
	...
	public BoolOutputComponent(Circuit circuit) {
		super(circuit);
