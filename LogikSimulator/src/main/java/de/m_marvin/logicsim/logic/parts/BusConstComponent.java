...
public class BusConstComponent extends Component {
	...
	public static boolean coursorMove(Circuit circuit, Vec2i coursorPosition) {
		return Component.coursorMove(circuit, coursorPosition, () -> new BusConstComponent(circuit));
	}
	...
	public BusConstComponent(Circuit circuit) {
		super(circuit);
		
		this.label = "bus_const";
	...
	public void serialize(JsonObject json) {
		...
		json.addProperty("state", this.value);
	}
	...
	public void deserialize(JsonObject json) {
		...
		this.value = json.get("state").getAsInt();
	}
	...
	public void render()  {
		...
		TextRenderer.drawText(visualPosition.x + getVisualWidth() / 2, visualPosition.y + getVisualHeight() / 2, 12, Long.toHexString(this.value));
